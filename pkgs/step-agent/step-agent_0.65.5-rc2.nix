...
let
  ...
  shaMap = {
    x86_64-linux = "1vkr79acyzij5zibw85h3g34qpqg8d8xhmxyx15jpbz6p2k9f6pn";
    aarch64-linux = "1qn0ddd54xzp8knxvfgfny92qp50cih72iff8pzwi6hb12wizqmn";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.5-rc2/step-agent_0.65.5-rc2_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.5-rc2/step-agent_0.65.5-rc2_linux_arm64.tar.gz";
  };
in
