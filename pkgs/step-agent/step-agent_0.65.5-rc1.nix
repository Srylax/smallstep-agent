...
let
  ...
  shaMap = {
    x86_64-linux = "1rgs0l7wvs8gqkpp327jmwkfgbwa8y7fjnyyg7jglar257vgp0b3";
    aarch64-linux = "1k5is6qxylvkjch3hw4m0c73v6mbnkaj0j1zz48s73nmf3xbfx4h";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.5-rc1/step-agent_0.65.5-rc1_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.5-rc1/step-agent_0.65.5-rc1_linux_arm64.tar.gz";
  };
in
