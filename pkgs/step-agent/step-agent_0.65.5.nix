...
let
  ...
  shaMap = {
    x86_64-linux = "16gs8rc4f5yrc9s5rmi60d7xmik2lclkacyrhq989qc75arflqqz";
    aarch64-linux = "1c3hc2d9ak73ax7kzs9bha3mhmligpismdzhkcyqy1spjyinfgjq";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.5/step-agent_0.65.5_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.5/step-agent_0.65.5_linux_arm64.tar.gz";
  };
in
